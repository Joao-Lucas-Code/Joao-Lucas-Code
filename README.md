...
[![My Skills](https://skillicons.dev/icons?i=py,js,ts,go,c,arduino,django,react,nextjs,tailwind,html,css,postgres,sqlite,supabase,aws,docker,linux,bash,git,github&perline=10)](https://skillicons.dev)
